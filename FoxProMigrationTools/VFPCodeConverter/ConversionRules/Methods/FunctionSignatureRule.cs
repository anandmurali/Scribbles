...
{
    public class FunctionSignatureRule : ConversionRuleBase, IConversionRule
    {
        #region Constructor

        public FunctionSignatureRule()
        {
            RuleName = "FunctionSignatureRule";
            RuleType = "Method";
        }
        #endregion
        ...
        public string ApplyConversionRule(string sourceCode, ConversionParameters conversionParameters)
        {
            ...
            if (match.Success)
            {
                ...
                string methodParameters = match.Groups["methodParameters"].ToString();
