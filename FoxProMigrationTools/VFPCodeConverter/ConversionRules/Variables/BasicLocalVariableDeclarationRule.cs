...
{
    public class BasicLocalVariableDeclarationRule : ConversionRuleBase, IConversionRule
    {
        #region Constructor

        public BasicLocalVariableDeclarationRule()
        {
            RuleName = "BasicLocalVariableDeclarationRule";
